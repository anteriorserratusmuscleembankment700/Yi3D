...
class WY3D_EXPORT Cone : public wy3d::Primitive
{
    WYDB_DECLARE_MEMBERS(Cone, wy3d::Cone, wy3d::Primitive)

public:
    static wy::ErrorStatus create(wydb::Transaction* pTrans, double radius, double height, Cone*& pOut);
