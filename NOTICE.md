...
- Open CASCADE Technology (OCCT)
  Copyright (c) Open CASCADE S.A.S. and others.
  Licensed under the GNU Lesser General Public License, Version 2.1 (LGPL-2.1).

- Qt 5
  Licensed under LGPL.  https://www.qt.io/

- OpenSceneGraph (OSG) / osgQt
  Copyright (C) 2002 Robert Osfield.
  Licensed under the OpenSceneGraph Public License (OSGPL) version 0.0
  (based on LGPL-2.1 with wxWindows Library Licence exceptions).
...
- WY Application Framework (WYAF)
  ...
  https://github.com/wangyao1052/WYAF
...
- FreeType
  Licensed under the FreeType License.  https://freetype.org/
...
- RTree
  Copyright (c) 2011-2024 Yariv Barkan.
  Released into the Public Domain, or alternatively under the MIT License.

- base64 (by René Nyffenegger)
  Copyright (C) 2004-2017 by René Nyffenegger.
  Licensed under a custom permissive license.
