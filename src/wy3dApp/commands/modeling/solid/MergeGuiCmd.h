...
#ifndef WY3DAPP_MERGE_GUI_CMD_H
#define WY3DAPP_MERGE_GUI_CMD_H
...
class MergeGuiCmd : public OsgGuiCommand
{
    WYRX_DECLARE_MEMBERS(MergeGuiCmd, wy3dApp::MergeGuiCmd, OsgGuiCommand)
public:
    MergeGuiCmd();
    virtual ~MergeGuiCmd();
...
private:
    // 合并
    bool merge(unsigned int errorCode);
...
private:
    ...
    friend class MergeGuiCmdMenu;
};

#endif // WY3DAPP_MERGE_GUI_CMD_H