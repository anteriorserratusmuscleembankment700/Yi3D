...
#ifndef WY3DAPP_SKETCH_LINE_GRIP_GIZMO_H
#define WY3DAPP_SKETCH_LINE_GRIP_GIZMO_H

#include "SketchEntityGripGizmo.h"
#include <wyVector2.h>
#include <wy3dSketchLine.h>

class SketchLineGripGizmo : public SketchEntityGripGizmo
{
public:
    enum class Type
    {
...
public:
    SketchLineGripGizmo(const wy3d::SketchLine* pSketchLine, Type type);
...
#endif // WY3DAPP_SKETCH_LINE_GRIP_GIZMO_H